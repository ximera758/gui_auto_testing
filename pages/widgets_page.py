...
from locators.widgets_locators import AccordianPageLocators, AutoCompletePageLocators, DatePickerPageLocators, \
    SliderPageLocators, ProgressBarPageLocators, TabsPageLocators, ToolTipsLocators, MenuPageLocators
...
class AccordianPage(BasePage):
    ...
    def check_accordian(self, accordian_num):
        ...
        section_title.click()
        try:
            section_content = self.element_is_visible(accordian[accordian_num]['title']).text
...
class AutoCompletePage(BasePage):
    ...
    def remove_value_form_multi(self):
    ...
    def check_colors_in_single(self):
...
class DatePickerPage(BasePage):
    ...
    def select_date(self):
        ...
        value_date_befor = input_date.get_attribute('value')
        input_date.click()
        self.set_date_by_text(self.locators.DATE_SELECT_MONTH, date.month)
        self.set_date_by_text(self.locators.DATE_SELECT_YEAR, date.year)
        self.set_date_item_from_list(self.locators.DATE_SELECT_LIST, date.day)
        value_date_after = input_date.get_attribute('value')
        return value_date_after, value_date_befor
...
class TabsPage(BasePage):
    ...
    def check_tabs(self, name_tab):
        ...
        button.click()
        what_content = self.element_is_visible((tabs[name_tab]['content']))
        return [button.text, what_content]
